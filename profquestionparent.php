...
echo 'Set new questions for topics taught recently for your Courses';
echo '</section>';
...
while($row = mysqli_fetch_array($result)) {
    ...
    echo "</td>";
    echo "<td>  <form method='POST' action='profquestion.php'>
    <input type='hidden' name='course_id' value=".$row['course_id'].">
    <input type='hidden' name='prof_id' value=".$row['prof_id'].">
    <input type='submit' value='Set' class='styled-button-5'> </form> </td>";
