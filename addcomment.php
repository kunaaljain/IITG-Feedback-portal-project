...
echo "Hello ".$stud_name.", Please give suggestions for ".$course_desc."(".$course_name.")"." which is taught by ".$prof_name;
echo '</section>';
?>
            <section class ="head1">
            Enter your Views
        ...
        <tr>
        <td>About Course</td>
        <td><textarea type="text" name="input1" ></textarea></td>
        </tr>
        <tr>
            <td>About Instructor</td>
            <td><textarea name="input2" ></textarea></td>
        </tr>
       </table></div>
    <p align="center">
