...
<form action="insertcoursestud.php" method="POST">
    <div ><br>
        <br>
    </div >
    <div>
        <div id="main"><?php echo '<section class ="head2">';
            ...
            <table class="features-table" margin-left:300;margin-top:100;>
                ...
                <tr>
                    ...
                    <td>
                        <?php
                        $qu="SELECT uc_users.id,uc_users.display_name,uc_user_permission_matches.permission_id FROM uc_users JOIN uc_user_permission_matches WHERE uc_users.id=uc_user_permission_matches.user_id AND uc_user_permission_matches.permission_id=1";
                        $con=mysqli_connect('localhost','root','',"usercake");
                        $result=mysqli_query($con,$qu);
