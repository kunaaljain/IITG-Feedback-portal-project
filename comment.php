...
echo 'Submit the Comments for the Course';
echo '</section>';
echo '<table class="features-table" margin-left:300;>';
echo "<thead>
                    <tr>
                        <td>Course Number</td>
                        <td>Course Name</td>
